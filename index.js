...
const HIDDEN_COLUMN_CHECKBOXES = new Set([
  ...
  "citaiton.reference",
  "citaiton.year",
  "compatibility.default_sim_command",
  "compatibility.uses_anchors",
  "compatibility.uses_cbngl_compartments",
  "compatibility.uses_deletes_molecules",
  "compatibility.uses_exclude_include_reactants",
  "compatibility.uses_generate_network",
  "compatibility.uses_moveconnected",
